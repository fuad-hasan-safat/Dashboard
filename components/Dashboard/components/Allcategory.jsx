...
import EditLekharPokaCategory from "./EditLekharPokaCategory";
...
const Allcategory = () => {
  ...
  function handleCategoryEdit(id, title, image = null){
    setEditCategory({
        id: id,
        title: title,
        image: image,
  ...
  if(isEditCategory === 'lekharPoka'){
    return <EditLekharPokaCategory setIsCategoryAdded={setIsCategoryAdded}/>
  }
                  ...
                  currentCategories.map((category, index) => (
                    <tr key={category._id} className="clearfix">
                      ...
                      <td>
                        ...
                        onClick={()=>handleCategoryEdit(category._id, category.title ,category.image)}
                        ></i>
                        <i
